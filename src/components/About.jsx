    ...
    <div className="-mt-[6rem]">
      ...
      <motion.p
        ...
        className="mt-4 text-taupe text-[18px] max-w-3xl leading-[30px]">
          ...
          <br />
          Now, if you read this all the way til the end you might be asking yourself if I used ChatGPT to create this piece of text, and the answer is of course! Writing good code is one of my strengths, but coming up with paragraphs that praise myself is definitely one of my weaknesses, which I have no problem admitting to :)
      </motion.p>
