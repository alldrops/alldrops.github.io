    ...
    <div className="-mt-[6rem]">
      ...
      <motion.p
        ...
        className="mt-4 text-taupe text-[18px] max-w-3xl leading-[30px]">
          ...
          <br />
          My tenure at TELUS Digital has been marked by leading dynamic teams in the design and execution of marketing and checkout pages that enhanced the customer journey. Utilizing React, NextJS, Styled Components and Contentful, I have been instrumental in mentoring and educating developers, fostering an environment of continuous learning and improvement. Our efforts have culminated in scalable, reusable components that have significantly benefitted TELUS and its affiliates.
      </motion.p>
